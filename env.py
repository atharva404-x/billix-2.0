"""
Alembic migration environment for Billix.

Supports both online (async) and offline migration modes.
Reads the database URL from the application config rather than alembic.ini.
"""
...
# from app.models import user, business, invoice  # noqa: F401 (future)
